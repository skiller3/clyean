...
# Specifications
`GENERAL_SPECS.md` contains Clyean's specifications, and will itself reference `AGENT_SPECS.md` which references Mermaid (*.mmd) files containing agent interaction workflows — **read all such files before doing any work!**
